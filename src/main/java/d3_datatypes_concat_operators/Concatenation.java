...
public class Concatenation {
    ...
    //Example 1: Create a String and two int variables. Print the string value and
    // the sum of the Integers to the console.

    //Java da "+" sembolu iki sayi arasinda kullanilirsa "toplama islemi" olur
    //Java da "+" sembolu iki String veya bir String ve bir sayi arasinda kullanilirsa "concatenation"
    // islemi olur
