...
public class DateTime01 {
    ...
    LocalDate myDate = LocalDate.now(); // now() methodu static bir methoddur.
    System.out.println(myDate); //2024-05-28
    ...
    System.out.println(myDate.getDayOfYear()); //149, yilin 149. gunu

    //--------------------
    //ornek 4:getDayOfMonth(): Ayin gününü alır.
    int day1 = myDate.getDayOfMonth();
    System.out.println(day1); //28
