...
public class Maps02 {
    public static void main(String[] args) {
        ...
        System.out.println(stdAges); //{Can=19, Ahmet=41, Tom=39, Veli=63, Ali=18}
        // degisiklik olmayacak cunku eski degeri 21 degil 39
        ...
        System.out.println(stdAges); //{Can=19, Ahmet=41, Tom=45, Veli=63, Ali=18} 77 eklemez cunku Tom map'te var

        stdAges.putIfAbsent("Ayse", 23);
        System.out.println(stdAges); //{Can=19, Ahmet=41, Tom=45, Veli=63, Ayse=23, Ali=18} eklendi cunku Ayse map'te yoktu
        ...
        System.out.println(stdAges.getOrDefault("Tom", 23)); //45, tom map'te var.orjinali geldi
