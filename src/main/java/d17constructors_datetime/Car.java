...
public class Car {
    ...
    //3-Main'li class'imizi olusturalim. Adi CarRunner olsun
    ...
    1-Parametresiz (default)
        a)Otomatik uretilen (Java)
        b)Kullanici tarafindan tanimlanan
    2-Parametreli

    */

    public Car(String brand, String model, int year, boolean hybrid) {
        this.brand = brand; //Bu class'taki brand'i (this.brand) kullanma, ben sana disardan yeni deger (brand) gonderecegim
        this.model = model;
        this.year = year;
        this.hybrid = hybrid;
    }
    //8- CarRunner class'a gidelim

    //13- Iki parametre kabul eden iki tane constructor olusturalim. Bitirince CarRunner'a gecelim
    ...
    //12- toString methodu olusturalim
