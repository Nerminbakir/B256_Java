...
public class HondaRunner {
    public static void main(String[] args) {
        ...
        */
        ...
        Cevap : child’da bir constructor icinde, super yazip parantez koymadan, nokta
        koyup parent’taki variable veya methodlara ulasabiliriz */
        ...
        //Honda h = new Honda("Accord"); //A- parametreli bir sekilde ogject urettim
