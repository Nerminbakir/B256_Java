...
public class Function01 {
    public static void main(String[] args) {
        ...
        */
        ...
        Lambda İfadesinin İmzasını Belirler: Fonksiyonel arayüzler lambda ifadesinin alacağı parametre
        sayısını ve türünü, dönüş türünü ve genel davranışını belirler. Bu, kodun daha okunabilir ve
        yönetilebilir olmasını sağlar.

        Anonim Sınıfların Yerini Alır: Java 8'den önce, anonim sınıflar genellikle tek metodlu işlevsellik
         için kullanılırdı.

        Lambda ifadeleri ve fonksiyonel arayüzler, bu kullanımı daha temiz ve daha az kodla gerçekleştirmeyi
         mümkün kılar.
         */
        //--------------------
        /*
        ...
        System.out.println("Sonuc : " + squaring.apply(6)); //Sonuc : 36
