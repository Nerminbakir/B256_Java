...
public class Sets01 {
    public static void main(String[] args) {
        ...
        //---------------HashCode gormek istersek
        String a = "Aliye Canan";
        System.out.println(a.hashCode()); //-539282105

        //Hash cakismasi olabilir - unique degiller ==> HashCode + equals()
        //---------------
        ...
        //Bu Set degistirilemezdir. Yeni eleman eklenemez ve mevcut elemanlar cikarilamaz
        System.out.println(hs3); //[Tuba, Kerem, Sinan, Onur] - JVM
        //----------------------
        ...
        //ODEV: Iki koleksiyon arasindaki farklari bulmak istiyorsak hangi methodu kullaniriz?
        ...
        ts.add('R');
        ts.add('U');
        //ts.add(null); HATA, null kabul etmez, null olsa dogal siralama olmazdi
        //null degerlerinin dogal bir siralamasi yoktur
