...
public class Maps01 {
    public static void main(String[] args) {
        ...
        */
        ...
        e) Performans:
            HashMap'ten daha yavaştır çünkü synchronized'dir ve her erişim için kilitlenir. lock
        */
        //----------------------
        /*
        3- ConcurrentHashMap
        ...
        */
        ...
        stdAges.put(null, 41);
        stdAges.put(null, 39); //key bolumunde tek null olur
        stdAges.put("a", null);
        stdAges.put("b", null); //value bolumunde birden fazla null olabilir
        ...
        //Eleman erisme
        System.out.println("Elmanin stock miktari: " + stock.get("Elma")); //Elmanin stock miktari: 10
