...
public class Animal { //public final class Animal - HATA final bir class'in child'i olmaz
    ...
    */
    ...
    veya belirli davranışları zorlamada yardımcı olmak için kullanılır.*/
        ...
        public void eat() {
            ...
            //pi = 3; HATA final bir degiskene yeni deger atayamazsiniz
        }
        ...
        public Animal create(){ //HATA: public final Animal create() -final bir method override edilemez
            return new Animal();
        }
