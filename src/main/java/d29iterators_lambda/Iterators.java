...
public class Iterators {
    public static void main(String[] args) {
        ...
        4)  Iterator'ler bir collection'dan eleman silme ve bir collection'daki
            elemani degistirme konusunda daha basarilidir
        ...
        while (listItr2.hasPrevious()){ //pointerin solunda eleman var mi diye bakar
            String el = listItr2.previous(); //previous pointer'i sagdan sola yerlestirir
