...
public class Maps01 {
    public static void main(String[] args) {
        ...
        myMap.put("Ali Can", 25); //key tekrarli kullanilirsa son value aktif olur. Ustune yazar
        ...
        System.out.println(myEntrySet); //[Fatma Yilmaz=19, Ali Can=25, Veli Han=18, Ayse Kaya=15] Set olarak elde ettik
