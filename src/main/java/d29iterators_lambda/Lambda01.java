...
public class Lambda01 {
    ...
    public static void printElements2(List<Integer> nums) {
        ...
        nums.stream().forEach(t -> System.out.print(t + " ")); //t degisken adidir (type'dan gelir).
        // Akıştan gelen her t için, o t'lerin herbirini yazdir. //12 9 131 14 9 10 4 12 15
    ...
    //Example 4: Find all even numbers in a List<Integer> and write a method that prints these numbers
    // to the console on the same line, with a space between them.(functional)
