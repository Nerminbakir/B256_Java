...
public class MethodOverloading01 {
    public static void main(String[] args) {
        ...
        */
        ...
        //-------------------------
        //String s = "Java";
        //s.substring(); Bir methodu olusturdugumuz object uzerinden cagiriyorsak, o method non-static'tir

        //Math.min(); Bir methodu direkt class adiyla cagiriyorsak, o method static'tir.
