...
public class Variables01 {
    public static void main(String[] args){
        ...
        int countryPopulation = 84234567;
        System.out.println("Ulke Nufusu : " + countryPopulation); //Ulke Nufusu : 84234567
        //countryPopulation.soutv ile otomatik label (etiket) yazar
        System.out.println("countryPopulation = " + countryPopulation); //countryPopulation = 84234567
